...
class WhiteStat:
    ...
    def GetUsageFrame(self):
        try:
            ...
            usageBytes.insert(3,"LSSeconds",lsSeconds,True)
    ...
    def GetDayNextFrame(self, prevTimeFrame, prevUsageFrame):
        try:
            ...
            nextUsageFrame.rename(columns = {'LSSeconds':'LSSeconds_NXT'}, inplace = True)
            ...
            newUsageFrame['LSSeconds'].fillna(newUsageFrame['LSSeconds_NXT'],inplace=True)
            ...
            newUsageFrame.loc[pd.isna(newUsageFrame.LSSeconds), 'LSSeconds'] = newUsageFrame["LSSeconds_NXT"]
            ...
            newUsageFrame.drop('LSSeconds_NXT', inplace=True, axis=1)
            ...
            newUsageFrame.loc[pd.isna(newUsageFrame.KBIn_NXT), 'LSTDAY_KBIn'] = 0.0
            newUsageFrame.loc[pd.isna(newUsageFrame.KBOut_NXT), 'LSTDAY_KBOut'] = 0.0
            newUsageFrame.fillna(value={'KBIn_NXT': 0.0, 'KBOut_NXT': 0.0}, inplace=True)        
    ...
    def ArchivePrevFrameToDB(self):
        ...
        try:            
            ...
            connection.execute(
                "INSERT INTO usagehistory(IP,MAC,Hostname,LSSeconds,KBIn,KBOut,[DATE],LSTDAY_KBIn,LSTDAY_KBOut) "
                "SELECT IP,MAC,Hostname,LSSeconds,KBIn,KBOut,[DATE],LSTDAY_KBIn,LSTDAY_KBOut "
    ...
    def GetDailyUsageRecords(self):
        ...
        try:            
            ...
            if count > 0:
                fields="IP,MAC,Hostname,LSSeconds,KBIn,KBOut,[DATE],LSTDAY_KBIn,LSTDAY_KBOut"

...
class RemoteUsageFrame(object):
    __slots__ = ['__weakref__', '_lock','_date','_localIPs','_remoteIPs', '_timeStamp']
    ...
    def GetFrame(self):
        return (self._date, self._localIPs, self._remoteIPs, self._timeStamp)

    def SetFrame(self, date, localIPs, remoteIPs):

        if ( date == "" or localIPs == "" or remoteIPs == ""):
            return
